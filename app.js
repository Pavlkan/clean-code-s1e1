...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.className="button-delite__icon";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("tasks__element_edit");
    ...
    listItem.classList.toggle("tasks__element_edit");
};
